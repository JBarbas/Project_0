class CentroAdministrativoMenu extends Phaser.Scene {
    ...
    create (data)  {
    	...
    	var expandir = this.add.image(game.global.buildingMenu.x + 170, game.global.buildingMenu.y + 700, 'btnExpandir').setInteractive();
    	...
    	this.colonos = this.add.image(game.global.buildingMenu.x + 170, game.global.buildingMenu.y + 600, 'btnColonos').setInteractive();
